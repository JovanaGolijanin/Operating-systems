...
#include <pthread.h>
#include <semaphore.h>
/*Deklaracije globalnih promenljivih koje su vidljive u svim funkcijama pa i u funkcijama niti*/
...
int empty2 = N2;
int empty3 = N3;
/*Indeksi pozicija za citanje i pisanje u bafer. Baferi B1, B2 i B3 se ponasaju kao FIFO baferi odnosno mora da postoji glava i rep*/
int head1 = 0;
int tail1 = 0;
int head2 = 0;
int tail2 = 0;
...
void * nit0(void * arg)
{
	...
	while(1)
	{
		...
		/*Ukoliko ne postoji nit N0 se blokira dok ne dobija signal da se oslobodila bar jedna pozicija*/
