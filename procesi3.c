...
int a[N][N];
	/*Funkcija niti*/
void * sortiranje(void * arg)   // ovo ne sortira lepo jer pointer i jeste "staticki" ali vrednost te promenljive se menja u glavnom programu, potrebno je da se cuva u nekom pomocnom nizu
{
...
int main()
{
	...
	/*Kreiramo niti */
	for (i = 0; i < N; i++)
		pthread_create(&niti[i], NULL, (void *)sortiranje /*funkcija nit*/, (void *)&i /*ulazni argument niti odnosno u ovom slucaju redni broj vrste*/);
